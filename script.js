...
<head>
  ...
  <link rel="apple-touch-icon" href="icon.png?v=14">
  <link rel="icon" type="image/png" href="icon.png?v=14">
  ...
  <div id="song-list">
    ...
    <div id="dnes-section-wrapper" class="section-content" style="display:none;">
      <div id="dnes-section" class="list-box"><div class="loading">Načítavam...</div>
        <h2 class="playlist-header-title" style="margin-top:18px;">HISTÓRIA</h2>
